...
find_program(CROSS_GCC_PATH gcc)
...
set(CMAKE_AS                ${TOOLCHAIN}/as         CACHE STRING "as")
set(CMAKE_AR                ${TOOLCHAIN}/gcc-ar     CACHE STRING "ar")
set(CMAKE_OBJCOPY           ${TOOLCHAIN}/objcopy    CACHE STRING "objcopy")
set(CMAKE_OBJDUMP           ${TOOLCHAIN}/objdump    CACHE STRING "objdump")
set(CMAKE_SIZE              ${TOOLCHAIN}/size       CACHE STRING "size")
...
set(CMAKE_C_FLAGS_INIT
	"${CPU_FLAGS} ${VFP_FLAGS} -fdiagnostics-color=always -fdata-sections -ffunction-sections"
	CACHE
...
set(CMAKE_EXE_LINKER_FLAGS_INIT
	"${LD_FLAGS} -Wl,--gc-sections -Wl,--start-group -lc -lm -Wl,--end-group -Wl,--print-memory-usage"
	CACHE
